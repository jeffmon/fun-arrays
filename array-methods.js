...
var hundredThousandairs = dataset.bankBalances.filter(function(item){
...
*/
var datasetWithRoundedDollar = dataset.bankBalances.map(function(item){
  return {
    "amount": item.amount,
    "state": item.state,
...
*/
var datasetWithRoundedDime = dataset.bankBalances.map(function(item){
  return {
    "amount": item.amount,
    "state": item.state,
...
/*var sumOfBankBalances = dataset.bankBalances.reduce(function(start, item){
  return item.amount;
}, 0);*/

var sumOfBankBalances = dataset.bankBalances.reduce(function(allAmounts, item){
  var total = allAmounts + Number(item.amount);
